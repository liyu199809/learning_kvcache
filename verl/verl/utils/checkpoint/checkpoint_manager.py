...
class BaseCheckpointManager:
    ...
    @property
    def should_save_trainable_only(self) -> bool:
        if not self.checkpoint_config:
            return False
        if isinstance(self.checkpoint_config, dict):
            return self.checkpoint_config.get("save_trainable_only", False)
        return getattr(self.checkpoint_config, "save_trainable_only", False)
