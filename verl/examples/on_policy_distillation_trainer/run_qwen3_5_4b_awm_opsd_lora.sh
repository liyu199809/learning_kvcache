#!/usr/bin/env bash
# LoRA 8-GPU AWM OPSD run: 6 GPUs for the FSDP2 actor/rollout and two
...
RUN_NAME=${RUN_NAME:-qwen3_5_4b_awm_opsd_lora_r${LORA_RANK}_a${LORA_ALPHA}}
...
# Kept aligned with the full-parameter launcher; override ACTOR_LR for LoRA sweeps.
...
echo "LoRA: rank=$LORA_RANK, alpha=$LORA_ALPHA, targets=$LORA_TARGET_MODULES, exclude=$LORA_EXCLUDE_MODULES"
