...
<tool_call>
{"name": "call_tool", "arguments": {"tool_name": <function-name>, "arguments": <args-json-object>}}
</tool_call>
...
You can select only one tool for execution at a time; multiple‑tool execution is prohibited."""
